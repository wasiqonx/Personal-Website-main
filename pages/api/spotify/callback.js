...
export default async (req, res) => {
  ...
  try {
    ...
    res.setHeader('Set-Cookie', [
      `spotify_access_token=${tokens.access_token}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=${tokens.expires_in}`,
      `spotify_refresh_token=${tokens.refresh_token}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=${30 * 24 * 60 * 60}`, // 30 days
      `spotify_token_expiry=${Date.now() + tokens.expires_in * 1000}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=${tokens.expires_in}`
    ])
