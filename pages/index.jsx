      ...
      <div className="bg-neutral-800/10 shadow-xl rounded-lg w-full h-auto mt-6">
          ...
          <div className="mt-4 max-w-2xl text-center text-lg text-white/90">
            ...
            <ul className="text-left list-disc list-inside space-y-2">
                <li><strong>Community Management:</strong> With 1.5 years of experience, I've worked on various projects, building and managing communities and developing social media strategies. During this time, I've successfully coordinated communities with thousands of members, adding value to multiple projects.</li>
            ...
            <p className="text-left"><strong>Sniper Search:</strong> My first project was a tool that allows you to check if a token is safe to invest in and get more info on it so you don't lose your investments. This initiative helped me gain significant experience in planning, development, and project management. (<a href="https://snipersearch.fun" rel="follow" target="_blank" className="text-blue-400 hover:text-blue-300">snipersearch.fun</a>)</p>
            <br></br>
            <h1 className="text-2xl font-bold text-white mt-6 mb-4"><strong>GOALS</strong></h1>
            <p className="text-left">I aim to reach wider audiences by sharing knowledge in the fields of digital assets and technology. With a focus on innovative thinking and professionalism, I strive to make a difference, especially in community management and social media.</p>
            <br></br>
