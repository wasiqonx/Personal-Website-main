...
export default function NewThesis() {
  ...
  return (
    <>
      <Head>
        <title>New Investment Thesis - Admin - Wasiq Syed</title>
      </Head>
      ...
      <div className="py-10">
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-3xl text-white font-semibold">Create New Investment Thesis</h1>
        </div>
          ...
          <div className="bg-neutral-800/10 rounded-lg p-8 space-y-6">
            ...
            <div className="bg-blue-600/10 border border-blue-600/30 rounded-lg p-4">
              <p className="text-blue-400 text-sm">
                ...
                <strong>Supported Hosts:</strong> ImageKit, any HTTPS PDF URL
              </p>
            </div>
            ...
            <div className="flex space-x-3">
              ...
              >
                {isLoading ? (
                  ...
                  <><i className="fas fa-check mr-2"></i>Create Thesis</>
                )}
              </button>
